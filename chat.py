...
with gr.Blocks() as demo:
    ...
    description = gr.Markdown(
        "Kurdish LLaMa is fine-tuned LLaMa model on the set of instruction provided by the Alpaca project with output of GPT4"
    )
        ...
        with gr.Column(variant="panel"):
            ...
            with input_component_column:
                input = gr.components.Textbox(
                    lines=2, label="Input", placeholder="سڵاو."
                )
